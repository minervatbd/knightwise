...
//   return (
//     <div className="flex flex-col items-center">
//       <div className="bg-gray-100 p-12 rounded-xl shadow-lg w-full max-w-3xl min-h-[500px] flex flex-col items-center justify-center">
...
//           {/* firstname */}
//           <div className="flex items-center space-x-6 w-full">
//             <label className="w-2/5 text-lg font-semibold text-gray-700">First Name</label>
//             <input
//               type="text"
//               placeholder="First Name"
//               className="w-3/5 px-6 py-4 text-lg border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
//               value={firstname}
//               onChange={(e) => setFirstname(e.target.value)}
//               required
//             />
...
//           {/* lastname */}
//           <div className="flex items-center space-x-6 w-full">
//             <label className="w-2/5 text-lg font-semibold text-gray-700">Last Name</label>
//             <input
//               type="text"
//               placeholder="Last Name"
//               className="w-3/5 px-6 py-4 text-lg border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
...
//           {/* username */}
//           <div className="flex items-center space-x-6 w-full">
//             <label className="w-2/5 text-lg font-semibold text-gray-700">Username</label>
//             <input
//               type="text"
//               placeholder="Username"
//               className="w-3/5 px-6 py-4 text-lg border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
...
//           {/* email */}
//           <div className="flex items-center space-x-6 w-full">
//             <label className="w-2/5 text-lg font-semibold text-gray-700">Email</label>
//             <input
//               type="email"
//               placeholder="Email"
//               className="w-3/5 px-6 py-4 text-lg border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
...
//           {/* password */}
//           <div className="flex items-center space-x-6 w-full">
//             <label className="w-2/5 text-lg font-semibold text-gray-700">Password</label>
//             <input
//               type="password"
//               placeholder="Password"
//               className="w-3/5 px-6 py-4 text-lg border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"
...
//           {/* confirm password */}
//           <div className="flex items-center space-x-6 w-full">
//             <label className="w-2/5 text-lg font-semibold text-gray-700">Password Confirm</label>
//             <input
//               type="password"
//               placeholder="Confirm Password"
//               className="w-3/5 px-6 py-4 text-lg border border-gray-300 bg-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-yellow-500"

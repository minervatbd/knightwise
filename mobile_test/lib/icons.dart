...
abstract class NavigationIcons {
  ...
  static const dashboardSelected = Icon(Icons.grid_view);
  static const topicSelection = Icon(Icons.chat_bubble_outline_outlined);
  static const topicSelectionSelected = Icon(Icons.chat_bubble_outline);
  static const mockTest = Icon(Icons.description_outlined);
  static const mockTestSelected = Icon(Icons.description);
